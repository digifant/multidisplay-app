...
!define PRODUCT_NAME "multidisplayUI_v2"
!define EXE_NAME "mUIv2.exe"
!define PRODUCT_VERSION "2.0-beta11.0-release-x86-df32-Qt5"
...
Name "${PRODUCT_NAME}"
OutFile "mUIv2-setup-2.0-beta11.0-release-x86-df32-Qt5.exe"
